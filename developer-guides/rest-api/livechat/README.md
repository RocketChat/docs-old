...
| `/api/v1/livechat/inquiries` | `GET` | Retrieves a list of open inquiries. | [info](inquiries/) |
| `/api/v1/livechat/inquiry.take` | `POST` | Take an open inquiry. | [info](inquiry-take/) |
