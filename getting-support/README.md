...
{% content-ref url="../quick-start/installing-and-updating/simple-deployment-methods/docker-and-docker-compose/docker-containers/" %}
[docker-containers](../quick-start/installing-and-updating/simple-deployment-methods/docker-and-docker-compose/docker-containers/)
{% endcontent-ref %}
...
| **3.18 (LTS)**      | [3.18.5](https://github.com/RocketChat/Rocket.Chat/releases/tag/3.18.5) | **Aug 2021** | **Mar 2022** |
...
The support is limited to installations matching the requirements described in the [Minimum ](../quick-start/installing-and-updating/introduction/hardware-requirements.md)[Hardware](../quick-start/installing-and-updating/introduction/hardware-requirements.md) [Requirements](../quick-start/installing-and-updating/introduction/hardware-requirements.md) page.
