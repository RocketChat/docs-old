...
{% hint style="info" %}
As a Rocket.Chat [Enterprise user](../../setup-and-configure/enterprise-edition-trial/) you can make use of the[ Facebook App](../../extend-rocket.chat-capabilities/rocket.chat-marketplace/omnichannel-apps/facebook-app/).
{% endhint %}
