...
To learn more about setting colors, see the \*\*\*\* [**colors section of the Basic White-labeling guide**](../../../setup-and-configure/accessing-your-workspace/basic-white-labeling.md#colors).
...
This section has a list of color swatches used in older versions of RocketChat. They can be edited and customized still. Learn more about color properties and what they affect in [this guide](../../../setup-and-configure/accessing-your-workspace/basic-white-labeling.md#colors).
