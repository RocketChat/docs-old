...
If the feature [Youtube Livestream](../../../../workspace-administration/settings/youtube-broadcasting.md) is enabled, the **Streaming** tab activates on the **Channel** **Actions** menu.
