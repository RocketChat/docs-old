...
If the feature [Youtube Livestream](../../../../rocket.chat-workspace-administration/settings/livestream-and-broadcasting.md) is enabled, the **Streaming** tab activates on the **Channel** **Actions** menu.
