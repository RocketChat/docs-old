...
We recommend installing using our[ Docker and Docker Compose guide](../../docker-and-docker-compose/) or using [Snaps](../../snaps/) as they are the easiest way for you to get your server up and running on all supported Linux distributions (Ubuntu, etc).

If you would like to enable TLS on your site like this `https://yoursite.com` when using the snap, please [this guide](../../snaps/auto-ssl-with-snaps.md)
