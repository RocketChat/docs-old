...
* [Schema Definition v2 \(Draft\)](api/schema-definition-v2/README.md)
  ...
  * [EventDataDefinition](api/schema-definition-v2/event-data-definition/README.md)
    * [IEventDataEmpty](api/schema-definition-v2/event-data-definition/i-event-data-empty.md)
    * [IEventDataRoom](api/schema-definition-v2/event-data-definition/ieventdataroom.md)
    * [IEventDataMessage](api/schema-definition-v2/event-data-definition/i-event-data-message.md)
    * [IEventDataUpdate](api/schema-definition-v2/event-data-definition/i-event-data-update.md)
