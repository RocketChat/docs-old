...
| delete-message | Permission to delete a message within a channel. See [deleting messages](../../user-guides/messaging/#delete-messages).
| delete-p | Permission to delete private channels.
| delete-user | Permission to delete users.
| edit-message | Permission to edit a message. See [editing messages](../../user-guides/messaging/#edit-messages).
