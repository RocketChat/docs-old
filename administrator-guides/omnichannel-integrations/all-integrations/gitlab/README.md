...
5. Go to your **GitLab** project (<https://gitlab.com/>< username >/< project >/hooks). It's in the project settings under the **Webhooks** menu in GitLab.
6. Paste the Rocket.Chat URL copied in Step 4, select at least one checkbox, and press the **Add Webhook** button.
7. In Gitlab, click **Test Hook** to check is your webhook works, a topbar should appear with  info such as success or failure.

Paste the following javascript in the **Script** text area of the Rocket.Chat webhook settings:
...
This example contains code for several hooks and can be easily extended. Read more information on:

- [Rocket.Chat/GitLab Hook](<https://github.com/malko/rocketchat-gitlab-hook>)
