...
Meanwhile, we continue to introduce all active and incoming students to open source in general, and Rocket.Chat's ecosystem of open source projects in particular.   Students will continue to amke meaningful open source contributions in the form issues & PR for our projects and interact with community + team.
