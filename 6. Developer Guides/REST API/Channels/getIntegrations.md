...
# Get Integrations
Retrieves the integrations which the channel has, requires the permission `manage-integrations` and supports the [Offset and Count Query Parameters](../Offset%20and%20Count%20Info.md).
