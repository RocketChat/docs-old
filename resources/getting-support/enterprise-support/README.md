...
{% content-ref url="../../../deploy-rocket.chat/deploying-rocket.chat/rapid-deployment-methods/docker-and-docker-compose/docker-containers/" %}
[docker-containers](../../../deploy-rocket.chat/deploying-rocket.chat/rapid-deployment-methods/docker-and-docker-compose/docker-containers/)
{% endcontent-ref %}
...
The support is limited to installations matching the requirements described in the [Minimum ](../../../deploy-rocket.chat/deploying-rocket.chat/hardware-requirements.md)[Hardware](../../../deploy-rocket.chat/deploying-rocket.chat/hardware-requirements.md) [Requirements](../../../deploy-rocket.chat/deploying-rocket.chat/hardware-requirements.md) page.
