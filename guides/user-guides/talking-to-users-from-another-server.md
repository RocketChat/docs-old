...
Once you have [added your server to the Federated Network](../administration/administration/settings/federation.md), you can talk to users from servers who have done the same.
