...
Once you have [added your server to the Federated Network](../rocket.chat-administrator-guides/settings/federation.md), you can talk to users from servers who have done the same.
