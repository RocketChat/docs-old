...
Once you have [added your server to the Federated Network](../administration/admin-panel/settings/federation/), you can talk to users from servers who have done the same.
