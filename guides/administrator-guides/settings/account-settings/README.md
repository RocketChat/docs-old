...
* **Hide Avatars**: Enabling this will hide users avatar in chat.
...
These settings are related to the Iframe Integration, please see the [[Iframe integration page](url)](../../../developer/iframe-integration/) for more details.
