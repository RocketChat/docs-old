...
{% content-ref url="administration/admin-panel/settings/federation/matrix-bridge/" %}
[matrix-bridge](administration/admin-panel/settings/federation/matrix-bridge/)
{% endcontent-ref %}
